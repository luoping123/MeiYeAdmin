<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['meiye:swiper:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['meiye:swiper:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="swiperList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="图片路径" align="center" prop="imageSrc" width="100">
...
<script>
import { listSwiper, getSwiper, delSwiper, addSwiper, updateSwiper } from "@/api/meiye/swiper";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('meiye/swiper/export', {
        ...this.queryParams
