...
public class NoticeController extends BaseController
{
     ...
     * 查询滚动通知列表
     */
    @PreAuthorize("@ss.hasPermi('meiye:notice:list')")
    @GetMapping("/list")
     ...
     * 导出滚动通知列表
     */
    @PreAuthorize("@ss.hasPermi('meiye:notice:export')")
     ...
     * 获取滚动通知详细信息
     */
    @PreAuthorize("@ss.hasPermi('meiye:notice:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增滚动通知
     */
    @PreAuthorize("@ss.hasPermi('meiye:notice:add')")
     ...
     * 修改滚动通知
     */
    @PreAuthorize("@ss.hasPermi('meiye:notice:edit')")
     ...
     * 删除滚动通知
     */
    @PreAuthorize("@ss.hasPermi('meiye:notice:remove')")
